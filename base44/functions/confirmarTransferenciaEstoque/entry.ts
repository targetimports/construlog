  ...
  try {
    ...
    for (const item of itens_confirmados) {
      ...
      await base44.entities.MovimentacaoEstoque.create({
        ...
        observacoes: `Transferência ${transferencia.numero} do estoque central para obra`
      });
    }
    ...
    return Response.json({
      ...
      observacao: 'Material agora disponível no estoque da obra para consumo'
    });
  } catch (error) {
